...
{
    public partial class AspCoreIThelp2020Context : DbContext
    {
        public AspCoreIThelp2020Context()
        {
        }

        public AspCoreIThelp2020Context(DbContextOptions<AspCoreIThelp2020Context> options)
            : base(options)
        {
        }
